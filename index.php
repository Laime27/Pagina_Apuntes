...
$sentenciaSQL = $conexion->prepare("SELECT *, count(*) as n_usuario FROM usuarios WHERE usuario = :usuario and contra = :contra");
...
if ($ListaUsuario["n_usuario"] > 0) {
    ...
    $_SESSION["usuarioID"] = $ListaUsuario["usuarioID"];
